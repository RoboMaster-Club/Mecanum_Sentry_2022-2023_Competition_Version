...
void Inverse_Kinematic_Calc(Chassis_t *Chassis)
{
	...
	Chassis->Wheel_Speed[0] = (Chassis->Chassis_Coord.Vx - Chassis->Chassis_Coord.Vy + Chassis->Chassis_Coord.Wz * (CHASSIS_LENGTH_HALF + CHASSIS_WIDTH_HALF)) * MOTOR_GEAR_RATIO;	// Rear Right
	Chassis->Wheel_Speed[1] = (Chassis->Chassis_Coord.Vx + Chassis->Chassis_Coord.Vy + Chassis->Chassis_Coord.Wz * (CHASSIS_LENGTH_HALF + CHASSIS_WIDTH_HALF)) * MOTOR_GEAR_RATIO;	// Front Right
	Chassis->Wheel_Speed[2] = (-Chassis->Chassis_Coord.Vx + Chassis->Chassis_Coord.Vy + Chassis->Chassis_Coord.Wz * (CHASSIS_LENGTH_HALF + CHASSIS_WIDTH_HALF)) * MOTOR_GEAR_RATIO; // Front Left
	Chassis->Wheel_Speed[3] = (-Chassis->Chassis_Coord.Vx - Chassis->Chassis_Coord.Vy + Chassis->Chassis_Coord.Wz * (CHASSIS_LENGTH_HALF + CHASSIS_WIDTH_HALF)) * MOTOR_GEAR_RATIO; // Rear Left
