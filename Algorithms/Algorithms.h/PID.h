...
#define Chassis_Small_Angle_PIDInit \
	{                               \
		0,                          \
			0,                      \
			0,                      \
...
#define Yaw_Angle_Follow_PIDInit \
	{                            \
		0,                       \
			0,                   \
			0,                   \
...
#define Yaw_Speed_Follow_PIDInit \
	{                            \
		0,                       \
			0,                   \
			0,                   \
...
#define Yaw_Angle_Reset_PIDInit \
	{                           \
		0,                      \
			0,                  \
			0,                  \
...
#define Yaw_Speed_Reset_PIDInit \
	{                           \
		0,                      \
			0,                  \
			0,                  \
...
extern PID_t Chassis_Small_Angle_PID;
extern PID_t Chassis_Speed_PID;
extern PID_t Fric_Wheel_PID;
extern PID_t Yaw_Angle_Follow_PID;
extern PID_t Yaw_Speed_Follow_PID;
extern PID_t Yaw_Angle_Spin_PID;
extern PID_t Yaw_Speed_Spin_PID;
extern PID_t Yaw_Angle_Start_PID;
